...
//    I've made is as a separate method and page class, because page with flawed products is build slightly differently
//    is build slightly differently than any other page written in CategoryName
