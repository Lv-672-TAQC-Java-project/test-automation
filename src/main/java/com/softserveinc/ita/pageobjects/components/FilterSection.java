...
public class FilterSection {
    ...
    public FilterSection setYear(String option) {
    ...
    public FilterSection setBrand(String option) {
    ...
    public FilterSection setModel(String option) {
    ...
    @Step("Set complete set option")
    public FilterSection setCompleteSet(String option) {
    ...
    public FilterSection selectTireSize(String tireSize) {
